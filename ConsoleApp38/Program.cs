...
namespace ConsoleApp38
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("t1:all arguments default");
            Console.WriteLine($"{t1.ToUniversalString()}");
            Console.WriteLine($"{t1.ToString()}\n");

            Console.WriteLine("t2: hour specified; minut and second default");
            Console.WriteLine($"{t2.ToUniversalString()}");
            Console.WriteLine($"{t2.ToString()}\n");


            Console.WriteLine("t3: hour and minute specified; second default");
